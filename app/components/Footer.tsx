...
export default function Footer() {
  ...
  // Jika hideFooter bernilai true, fungsi ini berhenti dan tidak menampilkan apapun
  if (hideFooter) {
    return null;
  }

  return (
    <footer className="bg-[#064663] p-6 text-white flex justify-between items-center px-10">
      ...
      <div className="flex gap-6 text-2xl">
        ...
        <a href="mailto:smkn2sumedang@yahoo.com" className="hover:text-red-400 transition" aria-label="Email">
         <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="5.83337" y="8.75" width="23.3333" height="17.5" rx="2" stroke="white" stroke-width="2"/>
          <path d="M5.83337 13.125L16.6056 18.5111C17.1687 18.7926 17.8314 18.7926 18.3945 18.5111L29.1667 13.125" stroke="white" stroke-width="2"/>
          </svg>
