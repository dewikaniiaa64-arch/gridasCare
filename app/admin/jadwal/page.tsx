      ...
      <main className="flex-1 p-8 bg-white overflow-x-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="bg-[#0D2840] text-white px-5 py-2.5 rounded-full font-semibold flex items-center gap-2 hover:bg-slate-800 transition shadow cursor-pointer"
          >
            <svg
        ...
        {/* Grid 5 Kolom Utama (Senin - Jum'at) */}
        <div className="grid grid-cols-5 gap-4 min-w-[800px]">
          {[
            ...
            <div
              key={item.hari}
              className="bg-[#93C5FD] rounded-2xl overflow-hidden shadow-sm flex flex-col border border-blue-200"
            >
              {/* Header Hari */}
              <div className="bg-[#0D2840] text-white text-center py-2.5 font-bold text-sm flex items-center justify-center gap-1.5">
                <span>📅</span> {item.hari}
              </div>
              ...
              <div className="flex flex-col divide-y divide-blue-300/60 flex-1">
                {jadwalData.map((slot, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-3.5 flex flex-col justify-between hover:bg-blue-300/40 transition-colors"
                    >
                      <div>
                        {/* Jam Jaga */}
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-slate-800 flex items-center justify-center text-white text-[11px] shrink-0">
                            👤
                          </div>
                          <div>
